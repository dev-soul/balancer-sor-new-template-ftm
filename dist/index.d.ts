...
declare class PoolCacher {
    ...
    constructor(provider: Provider, chainId: number, poolsUrl?: string | null, initialPools?: SubgraphPoolBase[]);
...
declare class SOR {
     ...
     */
    constructor(provider: Provider, chainId: number, subgraphUrl: string | null, initialPools?: SubgraphPoolBase[]);
    getPools(): SubgraphPoolBase[];
    /**
...
export { NewPath, NoNullableField, PoolBase, PoolDictionary, PoolFilter, PoolPairBase, PoolPairDictionary, PoolTypes, SOR, SubgraphLatestTokenPrice, SubgraphPoolBase, SubgraphToken, Swap, SwapInfo, SwapOptions, SwapPairType, SwapTypes, SwapV2, WeightedPool, parseToPoolsDict, BPTForTokensZeroPriceImpact as phantomStableBPTForTokensZeroPriceImpact, queryBatchSwapTokensIn, queryBatchSwapTokensOut, BPTForTokensZeroPriceImpact$1 as stableBPTForTokensZeroPriceImpact, BPTForTokensZeroPriceImpact$2 as weightedBPTForTokensZeroPriceImpact };
